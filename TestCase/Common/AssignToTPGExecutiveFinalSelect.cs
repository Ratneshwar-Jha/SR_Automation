...
{
    class AssignToTPGExecutiveFinalSelect
    {
        ...
        public void TPGExecutiveFinalSelect()
        {
            try
            {
                ...
                RG_Instance.ReportStepLog("TPG Executive Final Select", "Info", false);
                bcIOA.LoginWithRandomUser(Environment.GetEnvironmentVariable("TPGExecutiveName"));
                bcTPGA.TPGExecutiveActions("finalselect");
