    ...
    class TPGForwardReq
    {
        ...
        public void TPGForward()
        {
            try
            {
                ...
                //Environment.SetEnvironmentVariable("GenerateReqNum", "INDI/HCLI/2019/3060781");
                RG_Instance.ReportStepLog("TPG Manager Forward Requisition", "Info", false);
