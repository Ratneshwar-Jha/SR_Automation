...
{
    class InterviewerRejectProfile
    {
        ...
        public void InterviewerRejectTheProfile()
        {
            try
            {
                ...
                RG_Instance.ReportStepLog("Interviewer will reject the Profile Attached", "Info", false);
                ...
                bcINA.TakeInterviwerAction("reject");
