...
{
    class CR00020590_SLSkillingProgram
    {
        ...
        public void SriLankaSkillingProgram()
        {
            try
            {
                ...
                RG_Instance.ReportStepLog("Initiator is able to Select Cohort matrix  & able to Submit Requisition", "Pass", false);
