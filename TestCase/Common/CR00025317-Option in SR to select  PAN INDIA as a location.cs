...
{
    class CR00025317_OptionInSRToSelectPANINDIA_AsALocation
    {
        ...
        public void ConsentToHireResourceOnPANIndiaLocation_Yes()
        {
            try
            {
                ...
                RG_Instance.ReportStepLog("TPG Manager login check", "Info", false);
                bcIOA.LoginWithRandomUser(Environment.GetEnvironmentVariable("TPGName"));
                bcTPGA.TPGManagerActions("consenttohirepanindia");
        ...
        public void ConsentToHireResourceOnPANIndiaLocation_No()
        {
            try
            {
                RG_Instance.ReportStepLog("Initiator Creates Requisition ", "Info", false);
