...
{
    class CR00021125_HDNewL0Changes
    {
        ...
        public void HDNewL0Changes()
        {
            try
            {
                ...
                RG_Instance.ReportStepLog("Initiator is able to Select Infra BU & able to Submit Requisition", "Pass", false);
