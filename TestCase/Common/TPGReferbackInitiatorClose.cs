...
{
    class TPGReferbackInitiatorClose
    {
        ...
        public void TPGReferBackInitiatorClose()
        {
            try
            {
                ...
                //Environment.SetEnvironmentVariable("GenerateReqNum", "INDI/INDI/2019/3060474");
                ...
                RG_Instance.ReportStepLog("Initiator Close Requisition", "Info", false);
                bcIOA.AppLogin();
