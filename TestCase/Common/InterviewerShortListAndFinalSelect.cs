...
{
    class InterviewerShortListAndFinalSelect
    {
        ...
        public void InterviewerShortListFinalSelect()
        {
            try
            {
                ...
                RG_Instance.ReportStepLog("Interviewer will shortlist the Profile Attached", "Info", false);
                ...
                bcINA.TakeInterviwerAction("shortlist");
              
                RG_Instance.ReportStepLog("TPG Manager Final Select", "Info", false);
                bcIOA.LoginWithRandomUser(Environment.GetEnvironmentVariable("TPGName"));
                bcTPGA.TPGManagerActions("finalselect");
