...
{
    class CR00025060_TPGConfigurator
    {
        ...
        public void TPGConfigurator()
        {
            try
            {
                ...
                RG_Instance.ReportStepLog("TPG Manager configurator", "Info", false);
                bcIOA.LoginWithRandomUser(Environment.GetEnvironmentVariable("TPGName"));
                //bcIOA.LoginWithRandomUser("40181232");
                bcTPGA.TPGManagerActions("tpgconfigurator");
